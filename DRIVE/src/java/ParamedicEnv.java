...
public class ParamedicEnv extends Environment {
    ...
    public boolean executeAction(String agName, Structure action) {
        try {
			...
			//true when the paramedic has received all information regarding obstacles, potential victims, and hospital position
			...
			//non-crirical found at potential location
                ...
                //    +location(obstacle,2,2)[source(doctor)] <- ... addObstacle(X,Y) / {X=2, Y=2, D=v}
